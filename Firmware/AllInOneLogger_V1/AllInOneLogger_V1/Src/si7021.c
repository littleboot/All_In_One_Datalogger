...
getAirtemp(void)
{
  ...
  HAL_I2C_Master_Transmit (&hi2c1, si7021_adress, &cmd, 1, 500); //this function takes a byte as input adress. because the adress in the datasheet is 0x40 (7-Bit) it needs to be shifted left by one
